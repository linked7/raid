...
function ENT:Detonate()
	...
	self:EmitSound("physics/metal/metal_computer_impact_bullet1.wav"); -- you get a half second warning before you're dead
...
function ENT:Think()
	...
	if (CurTime() > self.DetonateTime and not self.Exploding) then
		self.Exploding = true;
		self:Detonate();
	end
